...
class Settings(BaseSettings):
    ...
    replay_speed: float = Field(default=100.0, env="REPLAY_SPEED")
    replay_timeframe: str = Field(default="30m", env="REPLAY_TIMEFRAME")
    replay_days: int = Field(default=365, env="REPLAY_DAYS")
